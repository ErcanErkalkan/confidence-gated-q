...
NAMES = {
    ...
    "knn_support": "kNN tolerance support",
}
...
def main() -> None:
    ...
    write_result_report(
        ...
        contrasts=[
            ...
            {
                "name": "knn_support_vs_dqn",
                "left": "knn_support",
                "right": "dqn",
                "metric": "risk_adjusted_score",
            },
            {
                "name": "knn_support_vs_fuzzy_reliability",
                "left": "knn_support",
                "right": "fuzzy_reliability",
                "metric": "risk_adjusted_score",
            },
        ],
    ...
    axis.set_title("Sensorized Crazyflie SIL held-out evaluation shift")
